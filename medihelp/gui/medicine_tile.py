...
class MedicineTile(tk.Frame):
    ...
    def __init__(self, parent, medicine: Medicine, users_id_to_name_dict: dict[int, str]):
        ...
        self._name_label = tk.Label(self, text=medicine.name(), font=(font_name, 14))
        ...
        self._buuton_frame = tk.Frame(self)
        self._buuton_frame.columnconfigure(0, weight=1)
        self._buuton_frame.columnconfigure(1, weight=1)
        self._take_dose_button = tk.Button(self._buuton_frame, text='Weź dawkę', font=(font_name, 10))
        self._take_dose_button.grid(row=0, column=0, sticky=tk.W)
        self._edit_button = tk.Button(self._buuton_frame, text='Edytuj', font=(font_name, 10))
        self._edit_button.grid(row=0, column=1, padx=10, sticky=tk.E)
        self._buuton_frame.pack(padx=padx, pady=pady+10, anchor='w', fill='x')
